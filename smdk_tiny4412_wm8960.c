	...
	struct snd_pcm_hw_params *params)
{
    ...
    printk("<%s,%d> [ethyn] set_hw_params.\n",__func__,__LINE__);
...
static struct snd_soc_ops smdk4412_wm8960_ops = {
...
static struct snd_soc_dai_link smdk4412_wm8960_dai_link = {
	.name = "Tin4412_wm8960",
	.stream_name = "Tin4412_wm8960",
	.codec_name = "wm8960-codec.0-001a",
	.codec_dai_name = "wm8960-hifi",
	.cpu_dai_name = "samsung-i2s.0",
	.ops = &smdk4412_wm8960_ops,
...
static struct snd_soc_card myalsa_card = {
	.name = "Tin4412_wm8960",
	.owner = THIS_MODULE,
	.dai_link = &smdk4412_wm8960_dai_link,
	.num_links = 1,
};
...
static int smdk4412_wm8960_init(void)
{
    printk("<%s,%d> [ethyn] init.\n",__FUNCTION__,__LINE__);
	platform_set_drvdata(&asoc_dev, &myalsa_card);
    platform_device_register(&asoc_dev);    
    return 0;
}

static void smdk4412_wm8960_exit(void)
{
    printk("<%s,%d> [ethyn] exit.\n",__FUNCTION__,__LINE__);
    platform_device_unregister(&asoc_dev);
}

module_init(smdk4412_wm8960_init);
module_exit(smdk4412_wm8960_exit);
